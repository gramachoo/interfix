...
Com a criação dos [diagramas](https://github.com/gramachoo/interfix/blob/main/Diagramas/ChamadosGestao.asta) apresentados nas sprints anteriores. O diagrama de componentes (deployment) foi criado para ter uma estrutura de como os componentes (hardware e software) do sistema funcionariam.   
